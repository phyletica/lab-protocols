...
- 1X Cutsmart Buffer
- 10 U of read 1 restriction enzyme (XbaI)
- 10 U of read 2 restriction enzyme (EcoRI)
- 0.33 &micro;M read 1 adapter (NheI/XbaI)
- 0.33 &micro;M read 2 adapter (EcoRI)

##### Procedure
1. Pipette 5 &micro;L of DNA at a concentrations of 20 ng/&micro;L onto 96 well plate.
2. Prepare enzyme digestion master mix.

| Enzyme Digestion Master Mix   | 1X            | 106X           |
| ----------------------------- | ------------- | -------------- |
| 10X CutSmart Buffer           | 1.5 &micro;L  | 159 &micro;L   |
| H<sub>2</sub>O                | 3.5 &micro;L  | 371 &micro;L   |
| Enzyme 1 20 U/&micro;L        | 0.5 &micro;L  | 53 &micro;L    |
| Enzyme 2 20 U/&micro;L        | 0.5 &micro;L  | 53 &micro;L    |
...
5. Add 2 &micro;L of 2.5 &micro;M each adapter.
6. Incubate samples in thermocycler with no heated lid at 37 &deg;C for 1 hour.
...
2. Pipette 43 &micro;L of master mix into each well of a 12 well strip tube or 65 &micro; into each well of an 8 well strip tube.
3. Using a multichannel pipette, add 5 &micro;L ligation master mix to each sample.
4. Incubate samples in thermocycler with no heated lid at:
    - 2 cycles of:
        - 22 &deg;C for 20:00
        - 37 &deg;C for 10:00
    - 80 &deg;C for 20:00
